...
const PAGE_META = {
  ...
  '/drivers':        { title: 'Drivers',         sub: 'Objective 2 — verify drivers & vehicles',   cta: '+ Add Driver'    },
  '/customers':      { title: 'Commuters',       sub: 'Objective 1 — manage commuter accounts',    cta: null              },
  '/bookings':       { title: 'Bookings',        sub: 'Objective 1 — manage ride bookings',         cta: null              },
  '/routes':         { title: 'Routes',          sub: 'Route viewing & trip planning',              cta: '+ Add Route'     },
  '/schedules':      { title: 'Schedules',       sub: 'Objective 2 — manage driver schedules',      cta: null              },
  '/reports':        { title: 'Reports',         sub: 'Objective 4 — complaints & reports',         cta: null              },
  '/ratings':        { title: 'Ratings',         sub: 'Objective 4 — commuter ride ratings',        cta: null              },
  '/payments':       { title: 'Payments',        sub: 'Objective 1 — fare records & transactions',  cta: null              },
  '/fares':          { title: 'Fare Manager',    sub: 'Objective 1 — fare inquiries & updates',     cta: null              },
  '/analytics':      { title: 'Analytics',       sub: 'Objective 3 — monitor system activity',      cta: null              },
  '/records':        { title: 'Ride Records',    sub: 'Objective 5 — generate ride records',        cta: null              },
  '/notifications':  { title: 'Notifications',   sub: 'Objective 3 — system activity & broadcasts', cta: null              },
